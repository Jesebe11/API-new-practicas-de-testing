...
class PostControllerTest extends TestCase
{
    ...
    public function test_store()
    {
        ...
        ->assertStatus(201);//la peticion se completo y se creo un recurso
    ...
    
    {
        ...
        $response = $this->actingAs($user, 'api')->json('POST', '/api/posts', [
            ...
            //la solicitud está bie hecha pero no se completó
    ...
    public function test_show()
    {
        ...
        ->assertStatus(200);//la peticion se completo y se creo un recurso
    }
